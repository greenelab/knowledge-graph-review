...
These applications vary from identifying protein functions to prediction disease gene assocaitions.
In this section we discuss various work that uses networks to undergo biomedical applications. 
We discuss selected methods and emhasize approaches that project networks into a low dimensional.
