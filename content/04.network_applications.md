...
This low dimensional representation loses the concept of a knowledge graph as only nodes are explicitly represented in this context. 
...
Similar to SVD, this representation loses the concept of a knowledge graph as only nodes are explicitly represented.
...
The representation generated by these approaches loses the concept of a knowledge graph as only nodes are explicitly represented.
...
Furthermore, knowledge graphs represented in this space are no longer considered knowledge graphs as only nodes are explicitly represented by these vectors.
