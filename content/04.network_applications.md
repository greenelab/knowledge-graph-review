...
Most approaches use word2vec variants to embed knowledge graphs into a low dimensional space.
As with other areas, it appears that translational models have been under-explored for these applications.
They integrated both networks under the assumption that a drugs associated with a disease interact with the same gene of interest. 
