...
Knowledge graphs represented in this space no longer meets our definition of a knowledge graph; however, this representation permits heavy computation such as calculating similarity metrics (e.g., cosine similarity [@arxiv:1910.09129]) or running machine learning classifiers.
...
This means a represented knowledge graph no longer meets our definition of a knowledge graph; however, this new representation ameliorates the ability to perform heavy computation such as running a deep learning model for biomedical applications.
