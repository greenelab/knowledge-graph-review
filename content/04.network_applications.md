...
In contrast with other applications where node2vec and autoencoder models have become established, deep learning methods in this area often use graph attention models [@arxiv:1706.03762].
...
Future directions consit of designing algorithms that can fill in this missing data gap or construct models that can take missing data into account.
