...
The input for this algorithm is an adjacency matrix ($A$), which is a square matrix where rows and columns represent nodes and each entry is a bianry representation of the presence of an edge between two nodes. 
