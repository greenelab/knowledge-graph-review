...
Typically, graphs for these applications are constructed from electronic health records (EHR) and nodes represent patients, drugs and diseases and edges represent relationships such as a patient being perscribed a treatment or a patient being diagnosed with a disease [@pmid:26306276; @doi:10.1145/2110363.2110415; @arxiv:1707.05340; @doi:10.1186/s12859-015-0549-5].
...
A limitation for both methods is that EHR records can have missing data for patients, which results in incomplete networks.

In contrast with other applications where node2vec and autoencoder models have become established, deep learning methods int his area often use graph attention models [@arxiv:1706.03762].
...
Other approaches have begun to adapt these graph attention models to perform clinical tasks such as drug safety recommendations [@doi:10.1609/aaai.v33i01.33011126] and patient diagnoses [@arxiv:1906.04716].
