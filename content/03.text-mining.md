...
Full text has already been show to make a dramatic improvements for methods that aim to infer relationships using cooccurrences [@doi:10.1371/journal.pcbi.1005962], and we should expect similar benefits for machine learning approaches.
