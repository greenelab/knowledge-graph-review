...
Database construction dates back all the way to 1956 where the first database contained a protein sequence of the insulin molecule [@doi:10.4172/jcsb.1000081].
...
This approach identified 543,405 disease gene associations [@doi:10.1016/j.ymeth.2014.11.020] and 792,730 high confidence protein-protein interactions [@doi:10.1093/nar/gks1094] but is limited to only using PubMed abstracts.
...
Besides the gradient problem, these approaches only peak in performance when the datasets reach at least a tens of thousands of data points [@arxiv:1707.02968].
