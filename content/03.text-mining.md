...
Unsupervised extractors have been focused on treating multiple biomedical relationships as multiple isolated problems.
These systems repeatedly use the same model for each biomedical relationship type.
...
Other efforts have embraced LSTMs to perform relationship extraction [@arxiv:1708.03743; @doi:10.1093/bioinformatics/btw486; @arxiv:1808.09101; @doi:10.1186/s12859-017-1609-9; @doi:10.1093/jamia/ocw180]. 
...
Other works have utilized CNNs and variants of CNNs to extract relationships from text [@doi:10.1177/0165551516673485; @doi:10.1093/database/bay073; @doi:10.1101/730085].
...
Nicholson et al. [@doi:10.1101/730085] found that, in some circumstances, these strategies can be reused across different types of biomedical relationships to learn a heterogeneous knowledge graph given that those relationships describe similar physical concepts.
