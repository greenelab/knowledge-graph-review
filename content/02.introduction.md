...
For this review, we define a knowledge graph as the following: a resource that integrates single or multiple sources of information into the form of a graph where a node repesents entites and an edge represents a relationship between two entites.
This graph structure allows for the capacity to make semantic interpretation, continuous incorporation of new information and uncover novel hidden knowledge through computational techniques and algorithms.
